...
import { Enum_NodesAction, FnKeys, Fn_Args_nets } from "../ActionComponents/ActionTypes/Types";

export class CalcStateStore {
    store!: ReduxState
    public active_state: IR_State<FnKeys> | null
    ...
    changeType(type: Enum_NodesAction) {
        ...
        this.active_state = { ...this.active_state, type: this.selected_type } as IR_State<FnKeys>
        this.active_state = { ...this.active_state, ...this.store[this.selected_type] }
    }
